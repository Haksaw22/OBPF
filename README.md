...
wants to stay) failed it: the truth is not a local optimum on 8/12 seeds, and under
...
- **[BLOG.md](BLOG.md) - the article** (abstract up top; formulation, gates, both
  failures, mechanisms, what survives). Start here.
...
affinity) and failed differently - its objective walks away from the truth for
representational reasons. Its failure analysis is **deprecated** but kept for the record,
